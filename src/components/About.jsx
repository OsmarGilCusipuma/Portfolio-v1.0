    ...
    <div className='section box-border' id='about'>
      <div className='lg:flex mx-auto gap-[150px] max-w-[1000px]'>
        ...
        <motion.div variants={fade("left", 1)} initial={"init"} whileInView={"view"} className='flex flex-col justify-center text-left p-5 flex-[2]'>
          ...
          <p className='text-white font-tertiary text-lg mt-3 font-light break-words'>Actualmente estoy cursando la carrera de Ingeniería de Sistemas de Información en la Universidad Peruana de Ciencias Aplicadas. Tengo 20 años y soy una persona analítica que busca hallar diversas soluciones a los problemas que se me presenten. Me gusta aprender por mi cuenta y mi objetivo a futuro es abarcar el apartado del back-end y desarrollo móvil.</p>
          <div className='flex gap-10 mt-6'>
            ...
            <div>
              ...
              <p className='text-white text-xl font-tertiary font-light'>Proyectos</p>
            </div>
          </div>
            <div className='mt-10'>
