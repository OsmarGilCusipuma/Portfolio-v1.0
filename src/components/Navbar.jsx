  ...
  return (
    <nav className='fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-30 p-4 lg:p-0'>
      <div className='container mx-auto'>
        <div className='flex items-center justify-around w-full bg-black/20 h-[60px] backdrop-blur-2xl max-w-[460px] mx-auto rounded-full'>
          <Link activeClass='is-active' className='cursor-pointer text-slate-200' to='home' spy={true} smooth={true} offset={-100} duration={500}>
